...
axs[0].set(xlabel="x")
axs[0].legend(["Analiticki", "3step","2step"], loc ="lower right")
...
axs[1].legend(["Analiticki", "3step","2step"], loc ="lower right")
...
axs[2].legend(["Analiticki", "Donji pravokutni","Gornji pravokutni","Trapezni"], loc ="lower right")
plt.show()